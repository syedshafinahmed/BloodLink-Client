...
const AuthLayout = () => {
  return (
    <div className="min-h-screen bg-[#f9232c]/20 flex items-center justify-center p-6">
      <div className="w-full max-w-6xl rounded-2xl shadow-2xl overflow-hidden grid md:grid-cols-2">
        ...
        <div className="flex items-center justify-center p-10 bg-white/10 backdrop-blur-2xl border border-white/20">
