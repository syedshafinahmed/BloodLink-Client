    ...
    <div className="max-w-7xl min-h-screen mx-auto mt-40 p-6">
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={handleFund}
            className="px-6 py-2 bg-red-600 text-base-200 rounded-lg hover:bg-red-700 transition"
          >
            Give Fund
          </button>
        </div>
      ...
      {loading ? (
        ...
        <motion.table
          ...
          className="w-full border-collapse text-center rounded-lg overflow-hidden shadow-md"
        >
          ...
          <tbody>
            {fundings.map((fund) => (
              <tr key={fund._id} className="border-b hover:bg-gray-100">
                ...
                <td className="p-3"><strong>৳ {fund.amount}</strong></td>
                <td className="p-3"><span className="badge badge-base badge-success">card</span></td>
                <td className="p-3">
