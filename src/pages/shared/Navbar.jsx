...
//   const links =
//     <>
//       <li className='text-base-200'><NavLink to="/">Home</NavLink></li>
//       <li className='text-base-200'><NavLink to="/about-us">About Us</NavLink></li>
//       <li className='text-base-200'><NavLink to="/services">Services</NavLink></li>
//       <li className='text-base-200'><NavLink to="/donors">Donors</NavLink></li>
//       <li className='text-base-200'><NavLink to="/donation-requests">Donation Requests</NavLink></li>
//       <li className='text-base-200'><NavLink to="/fundings">Funding</NavLink></li>
//       {
//         user &&
//         <>
//           <li className='text-[#f9232c]'><NavLink to="/dashboard/dhome">Dashboard</NavLink></li>
//         </>
//       }
//     </>
//   return (
//     <div
//       className={`w-full fixed top-0 z-50 transition-all duration-300 ${blur ? 'backdrop-blur-xl bg-[#f9232c]/10 shadow-sm' : 'bg-transparent'
//         }`}
//     >
...
//                   <div className="w-30 rounded border border-[#f9232c]">
//                     <img
//                       src={user.photoURL}
...
//                   </li>
//                   <li>
//                     <button onClick={handleLogout} className="text-[#f9232c]"><IoLogOut></IoLogOut>Logout</button>
//                   </li>
//                 </ul>
//               </div>
//               :
//               <NavLink to='/login'><button className="btn btn-outline font-black btn-[#f9232c]">Login</button></NavLink>
//             }
//           </div>
//         </div>
//       </div>
