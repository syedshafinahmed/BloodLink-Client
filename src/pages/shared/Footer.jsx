        ...
        <div className='max-w-7xl mx-auto'>
          <div className='grid grid-cols-1 md:grid-cols-4 gap-7 py-5 items-center'>
            <div className=''>
              ...
              <p className='text-justify px-4 text-xs mt-4'>BloodLink connects blood donors with recipients in need. It ensures fast access to verified donors, making the donation process simple and dependable.</p>
            </div>
            <div className=''>
